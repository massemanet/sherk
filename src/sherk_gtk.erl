...
%%% Created : 28 Sep 2015 by masse <masse@klarna.com>
...
update_targs(Ts,LD) ->
  update_treeview_list(aq_treeview,[[sherk:to_str(T)]||T<-Ts]),
...
pth([I],O) -> [sherk:to_str(I)|O];
pth([H|T],O) -> pth(T,[$:,sherk:to_str(H)|O]).
